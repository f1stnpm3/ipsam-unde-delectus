# @f1stnpm3/ipsam-unde-delectus
[![npm version](https://img.shields.io/npm/v/@f1stnpm3/ipsam-unde-delectus)](https://www.npmjs.com/package/@f1stnpm3/ipsam-unde-delectus)
[![Build Status](https://img.shields.io/github/actions/workflow/status/pinojs/@f1stnpm3/ipsam-unde-delectus/ci.yml?branch=main)](https://github.com/pinojs/@f1stnpm3/ipsam-unde-delectus/actions)
...
```sh
npm i @f1stnpm3/ipsam-unde-delectus
```
...
const ThreadStream = require('@f1stnpm3/ipsam-unde-delectus')
